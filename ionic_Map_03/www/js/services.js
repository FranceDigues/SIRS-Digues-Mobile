...
angular.module('data.services', [])
    ...
    .service('sCacheMap', function(pouchDB,$cordovaFileTransfer,$cordovaFile) {
    ...
    this.cache=function(url,geom,cacheName,LayerSourceName,zMin ,zMax){

        pointArray = geom.asArray();
        ...
        //
        //
        //function downloadTile( tile ,cacheName,LayerSourceName){
        //
        //

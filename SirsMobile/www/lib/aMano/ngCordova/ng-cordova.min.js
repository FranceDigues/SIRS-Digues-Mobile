...
!function () {
    angular.module("ngCordova", ["ngCordova.plugins"]), angular.module("ngCordova.plugins.actionSheet", []).factory("$cordovaActionSheet", ["$q", "$window", function (e, n) {
        ...
        this.setPreferences = function (e) {
            ...
            return {
                promptForRating: function (n) {
                    var t = e.defer(), o = AppRate.promptForRating(n);
    ...
    }]).run(["$cordovaBatteryStatus", function () {
    }]), angular.module("ngCordova.plugins.ble", []).factory("$cordovaBLE", ["$q", function (e) {
        return {
            scan: function (n, t) {
                var o = e.defer();
            ...
            }, notify: function (n, t, o) {
                var r = e.defer();
                return ble.notify(n, t, o, function (e) {
                    r.resolve(e)
                }, function (e) {
                    r.reject(e)
                }), r.promise
            }, indicate: function (n, t, o) {
                var r = e.defer();
                return ble.indicate(n, t, o, function (e) {
                    r.resolve(e)
                }, function (e) {
                    r.reject(e)
                }), r.promise
        ...
        return {
            createCalendar: function (t) {
                var o = e.defer(), r = n.plugins.calendar.getCreateCalendarOptions();
                ...
                var o = e.defer(), r = {title: null, location: null, notes: null, startDate: null, endDate: null};
                ...
                var o = e.defer(), r = [], i = window.plugins.calendar.getCalendarOptions(), a = {
                    title: null,
                    location: null,
                    notes: null,
                    startDate: null,
                ...
                var o = e.defer(), r = {newTitle: null, location: null, notes: null, startDate: null, endDate: null};
        ...
        return {
            save: function (n) {
                var t = e.defer(), o = navigator.contacts.create(n);
                ...
                var t = e.defer(), o = n.fields || ["id", "displayName"];
        ...
        return {
            show: function (t) {
                var o = n.defer();
                return t = t || {date: new Date, mode: "date"}, e.datePicker.show(t, function (e) {
                    o.resolve(e)
                }), o.promise
            }
        }
        ...
        return {
            getCurrentAcceleration: function () {
                ...
                var t = e.defer(), o = navigator.accelerometer.watchAcceleration(function (e) {
                    t.notify(e)
                }, function (e) {
                    t.reject(e)
                }, n);
        ...
        return {
            ...
            }, watchHeading: function (n) {
                var t = e.defer(), o = navigator.compass.watchHeading(function (e) {
                    t.notify(e)
                }, function (e) {
                    t.reject(e)
                }, n);
                return t.promise.cancel = function () {
                    navigator.compass.clearWatch(o)
                }, t.promise.clearWatch = function (e) {
                    navigator.compass.clearWatch(e || o)
                }, t.promise.watchID = o, t.promise
            }, clearWatch: function (e) {
        ...
        return {
            alert: function (t, o, r) {
                ...
                if (n.navigator.notification)navigator.notification.prompt(t, function (e) {
                    ...
                    var c = n.prompt(t, i);
                    a.resolve(null !== c ? {input1: c, buttonIndex: 1} : {input1: c, buttonIndex: 2})
                }
                return a.promise
            }, beep: function (e) {
        ...
        this.$get = ["$q", "$window", "$cordovaFileError", function (e, n, t) {
            return {
                getFreeDiskSpace: function () {
                    ...
                    try {
                        n.resolveLocalFileSystemURL(o, function (e) {
                            e.getDirectory(r, {create: !1}, function (e) {
                                e.remove(function () {
                    ...
                    try {
                        n.resolveLocalFileSystemURL(o, function (e) {
                            e.getFile(r, {create: !1}, function (e) {
                                e.remove(function () {
                                    i.resolve({success: !0, fileRemoved: e})
                                }, function (e) {
                                    e.message = t[e.code], i.reject(e)
                            ...
                            e.getFile(r, {create: !1}, function (e) {
                                e.file(function (e) {
                                    ...
                                    n.onloadend = function (e) {
                                        void 0 !== e.target._result || null !== e.target._result ? i.resolve(e.target._result) : i.reject(void 0 !== e.target._error || null !== e.target._error ? e.target._error : {
                                            code: null,
                    ...
                    try {
                        n.resolveLocalFileSystemURL(o, function (e) {
                            e.getDirectory(r, {create: !1, exclusive: !1}, function (e) {
                    ...
                    try {
                        n.resolveLocalFileSystemURL(o, function (e) {
                            e.getFile(r, {create: !1, exclusive: !1}, function (e) {
                                n.resolveLocalFileSystemURL(i, function (n) {
                                    e.copyTo(n, a, function (e) {
                                        c.resolve(e)
                                    }, function (e) {
        ...
        return {
            download: function (t, o, r, i) {
                var a = e.defer(), c = new FileTransfer, u = r && r.encodeURI === !1 ? t : encodeURI(t);
        ...
        return {
            getCurrentPosition: function (n) {
                ...
                var t = e.defer(), o = navigator.geolocation.watchPosition(function (e) {
                    t.notify(e)
                }, function (e) {
                    t.reject(e)
                }, n);
        ...
        return {
            login: function (t) {
                void 0 === t && (t = {});
                var o = e.defer();
                return n.plugins.googleplus.login({iOSApiKey: t}, function (e) {
                    o.resolve(e)
                }, function (e) {
                    o.reject(e)
                }), o.promise
                ...
                void 0 === t && (t = {});
                var o = e.defer();
                return n.plugins.googleplus.trySilentLogin({iOSApiKey: t}, function (e) {
                    o.resolve(e)
                }, function (e) {
                    o.reject(e)
                }), o.promise
        ...
        return {
            isAvailable: function () {
                ...
                var i = e.defer();
                return n.plugins.healthkit.saveWeight({unit: o || "lb", amount: t, date: r || new Date}, function (e) {
                    i.resolve(e)
                }, function (e) {
                    i.resolve(e)
                }), i.promise
                ...
                var o = e.defer();
                return n.plugins.healthkit.readWeight({unit: t || "lb"}, function (e) {
                    o.resolve(e)
                }, function (e) {
                    o.resolve(e)
                }), o.promise
                ...
                var i = e.defer();
                return n.plugins.healthkit.saveHeight({unit: o || "in", amount: t, date: r || new Date}, function (e) {
                    i.resolve(e)
                }, function (e) {
                    i.resolve(e)
                }), i.promise
                ...
                var o = e.defer();
                return n.plugins.healthkit.readHeight({unit: t || "in"}, function (e) {
                    o.resolve(e)
                }, function (e) {
                    o.resolve(e)
                }), o.promise
        ...
        }, this.$get = ["$rootScope", "$q", "$window", "$timeout", function (t, o, r, i) {
            return {
                open: function (a, c, u) {
                    var s = o.defer();
    ...
    }]), angular.module("ngCordova.plugins.keychain", []).factory("$cordovaKeychain", ["$q", "$window", function (e, n) {
        if ("Keychain"in n)var t = new Keychain;
        return {
            getForKey: function (n, o) {
                var r = e.defer();
                return t.getForKey(r.resolve, r.reject, n, o), r.promise
            }, setForKey: function (n, o, r) {
                var i = e.defer();
                return t.setForKey(i.resolve, i.reject, n, o, r), i.promise
            }, removeForKey: function (n, o) {
                var r = e.defer();
                return t.removeForKey(r.resolve, r.reject, n, o), r.promise
            }
        }
    }]), angular.module("ngCordova.plugins.localNotification", []).factory("$cordovaLocalNotification", ["$q", "$window", "$rootScope", "$timeout", function (e, n, t, o) {
        return document.addEventListener("deviceready", function () {
            n.plugin && n.plugin.notification && (n.plugin.notification.local.oncancel = function (e, n, r) {
                var i = {id: e, state: n, json: r};
                o(function () {
                    t.$broadcast("$cordovaLocalNotification:canceled", i)
                })
            }, n.plugin.notification.local.onclick = function (e, n, r) {
                var i = {id: e, state: n, json: r};
                o(function () {
                    t.$broadcast("$cordovaLocalNotification:clicked", i)
                })
            }, n.plugin.notification.local.ontrigger = function (e, n, r) {
                var i = {id: e, state: n, json: r};
                o(function () {
                    t.$broadcast("$cordovaLocalNotification:triggered", i)
                })
            }, n.plugin.notification.local.onadd = function (e, n, r) {
                var i = {id: e, state: n, json: r};
                o(function () {
                    t.$broadcast("$cordovaLocalNotification:added", i)
                })
            })
        }, !1), {
            add: function (t, o) {
                var r = e.defer();
                return o = o || null, n.plugin.notification.local.add(t, function (e) {
                    r.resolve(e)
                }, o), r.promise
            }, cancel: function (t, o) {
                var r = e.defer();
                return o = o || null, n.plugin.notification.local.cancel(t, function (e) {
                    r.resolve(e)
                }, o), r.promise
            }, cancelAll: function (t) {
                var o = e.defer();
                return t = t || null, n.plugin.notification.local.cancelAll(function (e) {
                    o.resolve(e)
                }, t), o.promise
            }, isScheduled: function (t, o) {
                var r = e.defer();
                return o = o || null, n.plugin.notification.local.isScheduled(t, function (e) {
                    r.resolve(e)
                }, o), r.promise
            }, hasPermission: function (t) {
                var o = e.defer();
                return n.plugin.notification.local.hasPermission(function (e) {
                    e ? o.resolve(e) : o.reject(e)
                }, t), o.promise
            }, promptForPermission: function () {
                var t = e.defer();
                return n.plugin.notification.local.promptForPermission(function (e) {
                    e ? t.resolve(e) : t.reject(e)
                }), t.promise
            }, registerPermission: function () {
                var t = e.defer();
                return n.plugin.notification.local.registerPermission(function (e) {
                    e ? t.resolve(e) : t.reject(e)
                }), t.promise
            }, getScheduledIds: function (t) {
                var o = e.defer();
                return n.plugin.notification.local.getScheduledIds(function (e) {
                    o.resolve(e)
                }, t), o.promise
            }, isTriggered: function (t, o) {
                var r = e.defer();
                return n.plugin.notification.local.isTriggered(t, function (e) {
                    r.resolve(e)
                }, o), r.promise
            }, getTriggeredIds: function (t) {
                var o = e.defer();
                return n.plugin.notification.local.getTriggeredIds(function (e) {
                    o.resolve(e)
                }, t), o.promise
            }, getDefaults: function () {
                return n.plugin.notification.local.getDefaults()
            }, setDefaults: function (e) {
                n.plugin.notification.local.setDefaults(e)
            }
        }
    ...
    }]).run(["$cordovaNetwork", function () {
    }]), angular.module("ngCordova.plugins.oauth", ["ngCordova.plugins.oauthUtility"]).factory("$cordovaOauth", ["$q", "$http", "$cordovaOauthUtility", function (e, n, t) {
        return {
            adfs: function (t, o, r) {
                var i = e.defer();
                if (window.cordova) {
                ...
                if (window.cordova) {
                    ...
                    if (r.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                        ...
                        i.addEventListener("loadstart", function (e) {
                            if (0 === e.url.indexOf("http://localhost/callback")) {
                                for (var n = e.url.split("#")[1], t = n.split("&"), r = [], a = 0; a < t.length; a++)r[t[a].split("=")[0]] = t[a].split("=")[1];
                                void 0 !== r.access_token && null !== r.access_token ? o.resolve({access_token: r.access_token}) : o.reject("Problem authenticating"), setTimeout(function () {
                                    i.close()
                                }, 10)
                            }
                        }), i.addEventListener("exit", function () {
                ...
                if (window.cordova) {
                    var a = cordova.require("cordova/plugin_list").metadata;
                    if (a.hasOwnProperty("org.apache.cordova.inappbrowser") === !0)if ("undefined" != typeof jsSHA) {
                        var c = {
                            ...
                            oauth_version: "1.0"
                        }, u = t.createSignature("POST", "https://api.twitter.com/oauth/request_token", c, {oauth_callback: "http://localhost/callback"}, r);
                        n.defaults.headers.post.Authorization = u.authorization_header, n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
                            ...
                            s.addEventListener("loadstart", function (e) {
                                if (0 === e.url.indexOf("http://localhost/callback")) {
                                    ...
                                    var f = t.createSignature("POST", "https://api.twitter.com/oauth/access_token", c, {oauth_verifier: u.oauth_verifier}, r);
                                    n.defaults.headers.post.Authorization = f.authorization_header, n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
                                        method: "post",
                                        url: "https://api.twitter.com/oauth/access_token",
                                        data: "oauth_verifier=" + u.oauth_verifier
                                    }).success(function (e) {
                        ...
                        r.addEventListener("loadstart", function (e) {
                            if (0 === e.url.indexOf("http://localhost/callback")) {
                                ...
                                if (void 0 !== i.access_token && null !== i.access_token) {
                                    var c = {access_token: i.access_token, expires_in: i.expires_in};
                                    t.resolve(c)
                ...
                if (window.cordova) {
                    var c = cordova.require("cordova/plugin_list").metadata;
                    if (c.hasOwnProperty("org.apache.cordova.inappbrowser") === !0)if ("undefined" != typeof jsSHA) {
                        var u = {
                            ...
                            oauth_timestamp: Math.round((new Date).getTime() / 1e3),
                            oauth_version: "1.0"
                        }, s = t.createSignature("POST", o + "/oauth/initiate", u, {oauth_callback: "http://localhost/callback"}, i);
                        n.defaults.headers.post.Authorization = s.authorization_header, n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
                            ...
                            var l = c.oauth_token_secret, f = window.open(o + "/oauth/authorize?oauth_token=" + c.oauth_token, "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
                ...
                if (window.cordova) {
                    ...
                    if (o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                        ...
                        r.addEventListener("loadstart", function (e) {
                            if (0 === e.url.indexOf("http://localhost/callback")) {
                                r.removeEventListener("exit", function () {
                                }), r.close();
                                for (var n = e.url.split("#")[1], o = n.split("&"), i = [], a = 0; a < o.length; a++)i[o[a].split("=")[0]] = o[a].split("=")[1];
                                void 0 !== i.access_token && null !== i.access_token ? t.resolve({
                                    access_token: i.access_token,
    ...
    }]), angular.module("ngCordova.plugins.oauthUtility", []).factory("$cordovaOauthUtility", ["$q", function () {
        return {
            createSignature: function (e, n, t, o, r, i) {
                if ("undefined" != typeof jsSHA) {
                    ...
                    return {signature_base_string: s, authorization_header: v, signature: t.oauth_signature}
                }
    ...
    }]), angular.module("ngCordova.plugins.progressIndicator", []).factory("$cordovaProgress", ["$q", function () {
        return {
            show: function (e) {
                var n = e || "Please wait...";
                ...
                var t = e || !1, o = n || "Success";
                return ProgressIndicator.showSuccess(t, o)
            }, showText: function (e, n, t) {
                var o = e || !1, r = n || "Warning", i = t || "center";
                return ProgressIndicator.showText(o, r, i)
            }, hide: function () {
                return ProgressIndicator.hide()
            }
        }
    }]), angular.module("ngCordova.plugins.push", []).factory("$cordovaPush", ["$q", "$window", "$rootScope", "$timeout", function (e, n, t, o) {
        return {
        ...
        return {
            openDB: function (e, t) {
                return "undefined" == typeof t && (t = 0), n.sqlitePlugin.openDatabase({name: e, bgType: t})

        ...
        this.$get = function(sPouch, AuthService, LocalDocument) {
            return {
                ...
                getClosableObjects: function() {
                    return LocalDocument.query('objetsNonClos/byLogin', { key: AuthService.getValue()._id, include_docs: true });
                },

                getClosedObjects: function() {
                    return LocalDocument.query('objetsClos/byLogin', { key: AuthService.getValue()._id, include_docs: true });
                }
            };
        };
    });
...
public class CoordinateConversion
{
  ...
  public GeoPoint latLon2UTM(double latitude, double longitude)
  {
  ...
  {
    public GeoPoint convertLatLonToUTM(double latitude, double longitude)
    {
      ...
      return new GeoPoint(((int) _northing),((int) _easting));
